...
Minstrel and SampleRate perform similarly. Minstrel sometimes has very poor performance on short traces--as low as 2mbps. This is because it does not stop sending after four successive failures, but must wait until the end of the 100ms window for statistics to be compiled.
