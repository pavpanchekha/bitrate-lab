...
Bit rate selection algorithms naturally show variation between runs on the same data because probe rates are chosen randomly. The variations were small, though. On ten runs on the \texttt{clear\_1.dat} trace, the average of Minstrel over 10 runs was 7.52 Mbps, with a maximum variation of +/- 0.12 Mbps. SampleRate was similarly stable, it averaged 5.284 Mbps over 10 runs, with a maximum variation of about +/- 0.3 Mbps

TODO: talk about histograms (table 2)

Some interesting patterns we noticed were that Minstrel had much fewer failures than SampleRate, usually between 0 and 10 for each run. SampleRate usually had one to two thousand failures on 30s. Minstrel's comparative lack of failures is due to the multi-rate retry chain. TODO: finish thought, talk about EWMA weighting problem
...
\begin{figure}[htb]
  \hspace{-.75em}\includegraphics[width=3.5in]{MinVSSam1.png}\vspace{-0em}
...
\begin{table*}[htb]
    ...
    \textbf{Rate in Mbps}     & \textbf{SampleRate} & \textbf{Minstrel}   & \textbf{Minproved}   \\ \hline
    1                & 770        & 39         & 29          \\
    2                & 298        & 82         & 20          \\
    5.5              & 5114       & 110        & 805         \\
    6                & 1412       & 137        & 276         \\
    ...
    36               & 16         & 6944       & 2030        \\
    48               & 16         & 6888       & 2009        \\
    54               & 16         & 7308       & 1953        \\ \hline
    \textbf{Avg. Throughput:} & \emph{5.42 Mbps}  & \emph{7.578 Mbps} & \emph{11.107 Mbps} \\
    \end{tabular}
    \caption{Histograms of the number of packets sent at each rate. This trace was recorded around the corner from the access point. The best fixed rate for this trace was 11 Mbps, which achieved a throughput of 9.625 Mbps. Minproved achieves a higher throughput than the best fixed rate.}
\label{table:2}
\end{table*}
